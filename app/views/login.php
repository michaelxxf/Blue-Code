        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to BOW BOW! 👋</h4>
              <p class="mb-4">Please sign-in to your account and to manage your branches</p>

              <form id="formAuthentication" class="mb-3" action="process-login" method="POST">
                <div class="mb-3">
                  <label for="merchant_email" class="form-label">Merchant Email</label>
                  <input
                    type="text"
                    class="form-control"
                    id="email"
