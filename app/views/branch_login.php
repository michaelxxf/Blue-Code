...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="mer-dash/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">BOW BOW</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Branch Portal 👋</h4>
              <p class="mb-4">Please sign-in to your branch account and start Transacting</p>

              <form id="formAuthentication" class="mb-3" action="branch/process-login" method="POST">
                <div class="mb-3">
                  <label for="branch_name" class="form-label">branch Login ID</label>
                  <input
                    type="text"
                    class="form-control"
                    id="email"
                    name="branch_name"
                    placeholder="Enter your Branch login ID"
                    autofocus
                    required
                  />
                </div>
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input
                      ...
                      placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                      aria-describedby="branch_password"
                      required
                    />
